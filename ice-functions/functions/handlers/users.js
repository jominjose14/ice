...
export function signup(req, res) {
    ...
    //Validation - setup errors object
...
export function getUserDetails(req, res) {
    ...
    .then(doc => {
        if(doc.exists) {
            ...
            .where('userHandle', '==', req.params.handle).orderBy('createdAt', 'desc').get();
        } else {
...
export function uploadImage(req, res) {
    ...
    busboy.on('finish', () => {
        admin.getStorage().bucket().upload(imageToBeUploaded.filepath, {
            resumable: false,
            metadata: {
                metadata: {
